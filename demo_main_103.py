...
if not cap103.isOpened():
    ...
    cv2.moveWindow(WIN_NAME,monitor.width//2,0)
    # A full size canvas
...
while True:
    ...
    canvas[0:monitor.height//2, 0:monitor.width//2] = cv2.resize(annotated_frame103, (monitor.width//2, monitor.height//2))
    ...
    cv2.putText(canvas, 'YOLOv8n', (25, 75), 2, 1.5, (0, 0, 0), 3)
    cv2.putText(canvas, 'YOLOv8n', (25, 75), 2, 1.5, (255, 255, 255), 2)
